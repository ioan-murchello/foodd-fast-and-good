 import logo1 from './assets/img/tabs/vegy.jpg';
 import logo2 from './assets/img/tabs/elite.jpg';
 import logo3 from './assets/img/tabs/hamburger.jpg';
 import logo4 from './assets/img/tabs/post.jpg';

//  ++++++++

import image1 from './assets/img/slider/paprika.jpg';
import image2 from './assets/img/slider/food-12.jpg';
import image3 from './assets/img/slider/olive-oil.jpg';
import image4 from './assets/img/slider/pepper.jpg';
...
export const listOfSLides = [
  { id: 1, image: image1, name: 'Paprika' },
  { id: 2, image: image2, name: 'Food' },
  { id: 3, image: image3, name: 'Olive' },
  { id: 4, image: image4, name: 'Pepper' },
];